...
type FellowshipApplicationsEmptyStateProps = {
  variant?: "default" | "compact";
  className?: string;
};

export function FellowshipApplicationsEmptyState({
  variant = "default",
  className,
}: FellowshipApplicationsEmptyStateProps) {
  ...
  return (
    ...
    >
      ...
      >
        Submissions will appear here once applicants complete the Leadership
